...
interface IERC20 {
    ...
    event bnbTransfer(address toAddress, uint256 amount);
}
...
contract MyLottoCoin is IERC20 {
    ...
    uint256 public airdropbnbCount = 0;
    ...
    */
    ...
    function airdropBNB(address payable[] memory _toAddresses, uint256[] memory _amount) public payable returns (bool) {
        ...
        for (uint256 i = 0; i < _toAddresses.length; i++) {
            ...
            emit bnbTransfer(_toAddresses[i], _amount[i]);
            airdropbnbCount = airdropbnbCount + 1;
        }
        return true;
    }
